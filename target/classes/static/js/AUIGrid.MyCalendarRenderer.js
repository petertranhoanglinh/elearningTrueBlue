 ...
 * AUIGrid 사용자 정의 렌더러
 */
AUIGrid.MyCalendarRenderer = AUIGrid.Class({
	...
	update : function() {
		...
		// 바차트 값 갱신
		this.__updateBarChart(ownData.value, ownData.value2, ownData.value3, ownData.value4);
	},
...
//	},
	...
	__createBarChart : function() {
		...
		var chartLabel = this.__chartLabel = document.createElement("p");
		chartLabel.className = "my-chart-label";
		
		var chartLabel2 = this.__chartLabel2 = document.createElement("p");
		chartLabel2.className = "my-chart-label2";
		
		var chartLabel3 = this.__chartLabel3 = document.createElement("p");
		chartLabel3.className = "my-chart-label3";
		
		var chartLabel4 = this.__chartLabel4 = document.createElement("p");
		chartLabel4.className = "my-chart-label4";
		
		
		chartBase.appendChild(chart);
		this.element.appendChild(chartLabel);
		this.element.appendChild(chartLabel2);
		this.element.appendChild(chartLabel3);
		this.element.appendChild(chartLabel4);
		this.element.appendChild(chartBase);
		
		// IE 메모리 누수 방지
		chart = chartBase = chartLabel = chartLabel2 = chartLabel3 = chartLabel4 = null;
	},
	
	// 차트 값 갱신
	__updateBarChart : function(value, value2, value3, value4) {
		var el = this.__chartLabel;
		var el2 = this.__chartLabel2;
		var el3 = this.__chartLabel3;
		var el4 = this.__chartLabel4;
	...
	//		this.__childEle2.style.display = "block";
			...
			this.__chartLabel2.style.display = "block";
			this.__chartLabel3.style.display = "block";
			this.__chartLabel4.style.display = "block";
	...
	//		this.__childEle2.style.display = "none";
			...
			this.__chartLabel2.style.display = "none";
			this.__chartLabel3.style.display = "none";
			this.__chartLabel4.style.display = "none";
